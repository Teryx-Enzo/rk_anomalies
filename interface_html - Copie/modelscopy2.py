...
class ResNet(BaseModel):
    ...
    def __init__(self, in_channels, num_classes):
        ...
        self.stg1 = nn.Sequential(
                                   ...
                                   nn.BatchNorm2d(64),
                                   nn.ReLU(inplace=True),
                                   nn.MaxPool2d(kernel_size=3, stride=2))  # Taille réduite de moitié, soit 128x128
        ...
        ## Classify
        self.avgpool = nn.AvgPool2d(kernel_size=8)  # Pooling to reduce dimensions
        
        # Aplatir la sortie et ajuster la taille de la couche linéaire à 1024*4*4 = 16384
        self.classifier = nn.Sequential(
                                       nn.Flatten(),
                                       nn.Linear(1024 * 4 * 4, num_classes))  # Ajusté pour 16384 entrées
    ...
    def forward(self,inputs):
        ...
        out = self.avgpool(out)  # Pooling to reduce dimensions
        
        out = self.classifier(out)  # Flatten and pass through Linear
